...
const AllPets = () => {
    ...
    const fetchPets = async () => {
        ...
        const { data } = await axiosPublic.get('/allPets', {
            params: {
    ...
    return (
        <Box className="p-4 lg:px-10">
            <Text className='text-5xl text-slate-100 text-center font-bold bg-black  uppercase '  as="h2" fontSize="2xl" mb="4">All Pets</Text>
